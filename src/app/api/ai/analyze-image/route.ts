...
export async function POST(req: NextRequest) {
    try {
        ...
        const prompt = `วิเคราะห์รูปภาพบิล ใบเสร็จ นามบัตร หรือภาพหน้างานแอร์นี้\n\nแยกข้อมูลและตอบกลับเป็นรูปแบบ JSON เท่านั้น โดยปฏิบัติตามกฎต่อไปนี้อย่างเคร่งครัด:\n\n1. customerName: "ชื่อลูกค้า" (ถ้าในภาพมีชื่อคน)\n2. phone: "เบอร์โทรศัพท์" (ถ้ามี)\n3. address: "ที่อยู่สถานที่ หรือชื่อโครงการ" (ถ้ามี)\n4. serviceType: เลือก 1 ในหมวดหมู่ต่อไปนี้ถ้าพอเดาได้จากรูป: "ล้างแอร์", "ซ่อม", "ติดตั้ง", "ตรวจสอบ" หรือ "อื่นๆ"\n5. description: "อธิบายสิ่งที่คุณเห็นในภาพ เช่น ยี่ห้อแอร์ อาการเสีย หรือรายละเอียดบิล"\n\nตอบเป็น JSON ล้วนๆ ห้ามมีเครื่องหมาย markdown หรือ \`\`\` ครอบ และห้ามมีคำอธิบายเพิ่มเติม:\n{"customerName":"","phone":"","address":"","serviceType":"","description":""}`;
